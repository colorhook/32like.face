...
exports.detectByBaidu = function(img, callback){
  ...
  request.get({
    ...
    console.log(JSON.parse(tplConf.keywords)[2].keyword);
    console.log(JSON.parse(tplConf.sameData));
    //console.log(tplConf.sameData);
    //console.log(tplConf.simiData);
  })
}
/*
...
*/
var img = 'http://mmbiz.qpic.cn/mmbiz/QONj06oVo0vO864Bia6L9oOoZNiapr4ibzrluDt5FMCkgD2jcTOwfLmgH1ZOGiclnSiaM7I7UbFNxicG89dpGD96GJtw/0';
exports.detectByBaidu(img, function(e, json){
  //console.log(json.attributes.gender.value);
});